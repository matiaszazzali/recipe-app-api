...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipes(self):
        """Test retrieven a list of recipes."""
    ...
    def test_update_user_returns_error(self):
        ...
        paylodad = {'user': new_user.id}
        url = detail_url(recipe.id)
        self.client.patch(url, paylodad)
    ...
    def test_create_tag_on_update(self):
        ...
        # dont need to refresh db.'recipe.tags.all()' generates new query
    ...
    def test_filter_by_ingredients(self):
        ...
        in2 = Ingredient.objects.create(user=self.user, name='Tahini')
